...
main(void)
{
    ...
    static const char *PAGER_CONTENT =
        ...
        "Test\n"
        "\n\n"
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ornare, diam"
        "vitae lobortis suscipit, dui lacus varius sem, eget varius nunc risus in purus."
        ...
        "vestibulum."
        "\n\n"
        "Donec eget vestibulum libero. Duis tellus felis, pretium eu mattis eu, vehicula"
        "hendrerit velit. Sed volutpat egestas tincidunt. Ut a mattis risus. Integer"
        "eget tempus nisi, sit amet condimentum metus. In pharetra molestie lorem,"
        "vehicula condimentum est tincidunt id. Nulla et felis vitae sapien maximus"
        "congue. Etiam risus urna, porta et pulvinar eget, imperdiet ut tellus."
        "\n\n"
